...
import com.tuepoo.weibo.adapter.EmotionGvAdapter;
import com.tuepoo.weibo.adapter.EmotionPagerAdapter;
import com.tuepoo.weibo.adapter.WriteStatusRvGridAdapter;
...
import com.tuepoo.weibo.utils.DisplayUtils;
import com.tuepoo.weibo.utils.EditTextStringUtils;
import com.tuepoo.weibo.utils.EmotionKeyBoardUtils;
import com.tuepoo.weibo.utils.EmotionUtils;
import com.tuepoo.weibo.utils.ImageUtils;
import com.tuepoo.weibo.utils.StringUtils;
...
public class WriteStatusActivity extends BaseActivity implements View.OnClickListener, AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shareHandler = new WbShareHandler(WriteStatusActivity.this);
    ...
    private void sendStatus() {
        ...
        new RequestWeiboApi(this).statusesSend(statusContent, uri, retweetedStatusId, new SimpleRequestListener(this, null) {
            @Override
