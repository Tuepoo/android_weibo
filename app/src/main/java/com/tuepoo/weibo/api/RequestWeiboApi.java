 ...
 * 微博接口调用以及接口工具类封装
 */
public class RequestWeiboApi extends AbsOpenApi {
     ...
     */
    public RequestWeiboApi(Context context, String appKey, Oauth2AccessToken accessToken) {
     ...
     */
    public RequestWeiboApi(Context context) {
     ...
     * 查询首页微博
     */
    public void statusesPublic_timeline(long page, RequestListener listener) {
        WeiboParameters parameters = new WeiboParameters(Constants.APP_KEY);
        parameters.put("page", page);
        requestInMainLooper(CommonConstants.statuses_public_timeline, parameters, HTTPMETHOD_GET, listener);
    }
