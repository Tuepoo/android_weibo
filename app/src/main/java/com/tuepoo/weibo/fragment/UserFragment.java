package com.tuepoo.weibo.fragment;
...
import com.tuepoo.weibo.BaseFragment;
import com.tuepoo.weibo.R;
import com.tuepoo.weibo.activity.FansActivity;
import com.tuepoo.weibo.activity.FriendsActivity;
import com.tuepoo.weibo.activity.SettingActivity;
import com.tuepoo.weibo.activity.UserAllStatusActivity;
import com.tuepoo.weibo.activity.UserInfoActivity;
import com.tuepoo.weibo.adapter.HeaderAndFooterRecyclerViewAdapter;
import com.tuepoo.weibo.adapter.UserItemAdapter;
...
import com.tuepoo.weibo.entity.UserItem;
import com.tuepoo.weibo.utils.ImageOptHelper;
import com.tuepoo.weibo.utils.RecyclerViewUtils;
...
public class UserFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private RequestWeiboApi weiboApi;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        weiboApi = new RequestWeiboApi(mainActivity);
    ...
    private void setItem() {
        userItems.add(new UserItem(true, R.mipmap.push_icon_app_small_8, "新的好友", ""));
//        userItems.add(new UserItem(true, R.mipmap.push_icon_app_small_1, "新手任务", "完成任务，抽取大奖"));
        userItems.add(new UserItem(true, R.mipmap.push_icon_app_small_2, "我的相册", ""));
