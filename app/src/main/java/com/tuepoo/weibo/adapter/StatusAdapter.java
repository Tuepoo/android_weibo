...
import com.tuepoo.weibo.activity.ImageBrowserActivity;
import com.tuepoo.weibo.activity.StatusDetailActivity;
import com.tuepoo.weibo.activity.UserInfoActivity;
import com.tuepoo.weibo.activity.WriteCommentActivity;
import com.tuepoo.weibo.entity.PicUrls;
import com.tuepoo.weibo.entity.Status;
import com.tuepoo.weibo.entity.User;
import com.tuepoo.weibo.utils.DateUtils;
...
public class StatusAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public StatusAdapter(Context context, List<Status> datas,WbShareHandler shareHandler) {
        this.context = context;
        this.datas = datas;
        imageLoader = ImageLoader.getInstance();
        ...
        if (vh instanceof ViewHolder) {
            ...
            holder.ll_share_bottom.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    textObject.text =  status.getText();
